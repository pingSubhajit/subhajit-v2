...
const ProjectCard = ({
	...
	return (
		<TransitionLink
			href={`/projects/${slug}`}
			className="w-full border-t-[1px] border-ghidorah last-of-type:border-b-[1px]"
		>
			<div
				onMouseEnter={() => {
			...
			xl:py-16 2xl:py-20 px-8 lg:px-20 xl:px-24 cursor-pointer transition-all duration-200
			hover:opacity-50 group text-black"
			>
