...
import {opacity, slideUp} from '@/components/description/animation'
	...
	return (
		<div ref={description} className="px-14 lg:px-28 xl:px-36 2xl:px-48 flex justify-center relative">
			<div className="max-w-[1400px] flex flex-col lg:flex-row gap-8 2xl:gap-12 text-black">
				...
				<motion.div variants={opacity} animate={isInView ? 'open' : 'closed'} className="max-w-80 md:text-base lg:max-w-full lg:text-xs xl:text-sm 2xl:text-lg w-[80%]">
